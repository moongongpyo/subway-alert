...
공식 공지 수집, 서버 캐시/호출 예산, 경로·대시보드 원문 표시를 추가했습니다. 사용자 서울시 키의 실제 응답 성공을 확인했으며, 종료 시각과 미확인 상태를 구분합니다. 기존 위치·도착 추정과 별개입니다. Java 테스트 20개 통과 및 JavaScript 문법 검사 완료. TMAP 키는 여전히 미연결입니다.
