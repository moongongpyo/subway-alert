...
$('#open-simulation').onclick=()=>{if(savedPlaces)sessionStorage.setItem('mock-route-places',JSON.stringify(savedPlaces));location.href='/?simulation=1'+($('#mock-example').checked?'&example=1':'');};
